...
\begin{document}
	\maketitle
	\textbf{Targeting Journals:}
	\begin{itemize}
		\item \href{https://www.nature.com/natmachintell/reviews-and-analysis?type=review-article&year=2023}{\textit{Nature Computational Science}}
		\item  \href{https://www.nature.com/natcomputsci/reviews-and-analysis?type=review-article&year=2023}{\textit{Nature Machine Intelligence}}
	\end{itemize}
	\begin{abstract}
		\textcolor{red}{This will be written after finalizing the first draft.}
	\end{abstract}
	...
	\begin{figure}
		...
		\caption{A layman introduction to the concepts of longitudinal multiomics study, unbalanced sampling design, time-to-event feature and missing data. In this study the first two subjects were observed at the same time-points which induces a balanced sampling design although the time-points are irregular. For the fourth and fifth subjects the sampling suspended by leave of the subjects from study. The time of the leave is a random time and this is considered as a time-to-event model. The survival data are categorized in this group and the random leaving time inevitably produces an unbalanced design. The missing also can take place for whole of and omic data or for the abundances of some features at some time-points. }\label{Pipeline1}
	\end{figure}
	
	The growth of longitudinal studies on omics data is also considerable. \autoref{Pubsight1} (demonstrated by \href{https://github.com/omicsEye/pubSight}{\texttt{pubSight}}) shows this trend within PubMed and Scopus databases and there are plenty of them on the other databases. 
	\begin{figure}
		\centering
		\includegraphics[scale=.2]{pubmed_ggplot.eps}
		\includegraphics[scale=.2]{scopus_ggplot.eps}
		\caption{The trend of publications based on longitudinal omics studies within the last 8 decades in PubMed (panel a) and Scopus (panel b) databases.}\label{Pubsight1}
	\end{figure}
