...
\begin{document}
	...
	\begin{figure}
		\centering
		\includegraphics{pubmed_fig.eps}
	...
	\begin{sidewaystable}
		...
		\section{Frequentist LMM based approaches}
		...
		\section{Trajectory of measurements per subject}
		\subsection{Survival, dropout or censored}
		...
		\subsubsection{LMM alongside Cox regression}
		...
		\subsubsection{Integrated Ornestein-Uhlenbeck random effect}
 		...
 		\cite{WangTaylor2001}
		\subsubsection{Change-point detection model}
		...
		\section{Study obstacles}
		\subsection{Correlated outcomes}
		\cite{Chengetal2019}
		\subsection{Time-varying covariates}
		\cite{Chengetal2019}
		\subsection{Nonlinearity and nonstationarity}
		\cite{Chengetal2019}
		...
		\subsection{Joint modeling of longitudinal and time-to-event data}
		Alongside the longitudinal observations
		\begin{enumerate}
			\item 
		\end{enumerate}
